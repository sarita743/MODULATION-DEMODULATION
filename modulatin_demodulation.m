...
switch method
    case 1
        v=modulate(y,fc,fs,'am');  %amplitude modulation
        x=demod(v,fc,fs,'am');     %amplitude demodulation
        subplot(4,1,1);
        plot(t',y);
        xlabel('Time');
        ylabel('Amplitude');
        ...
        sound(x)
    case 2
        v=modulate(y,fc,fs,'fm');  %frequency modulation
        x=demod(v,fc,fs,'fm');     %frequency demodulation
        subplot(4,1,1); 
        plot(t',y);
        xlabel('Time');
        ylabel('Amplitude');
